...
class ContentController:
    ...
    def _initialize_chat_messages(self) -> None:
        if self.source_type == "webpage":
            system_msg = "You are an assistant discussing a webpage. Use the provided page text as context. Keep your answers concise."
            ...
            system_msg = "You are an assistant discussing a YouTube video. Use the subtitles as context. Keep your answers concise."
            ...
            system_msg = "You are an assistant. Use the provided content as context and keep answers concise."
